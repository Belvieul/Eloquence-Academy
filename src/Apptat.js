...
const allAchievements = [
  // ORIGINAL 9 ACHIEVEMENTS (keep these!)
  ...
  // NEW PLATINUM ACHIEVEMENTS (6) - NEW TIER!
...
const checkAchievements = async () => {
  ...
  // Month Long Streak - PLATINUM (30 days)
  ...
  // Category Specialist (5 words from one category)
  const categories = ['Intellectual Discussion', 'Refined Compliments', 'Literary Expression', 
  ...
  // Category Master (10 words from 3 categories)
  ...
  // Complete Mastery - PLATINUM (15+ from all 7 categories)
  ...
  try {
    ...
    // Flawless Record - PLATINUM (10 perfect scores)
  ...
  // The Perfectionist (5 perfect scores in a row)
  try {
  ...
  // Scholar Supreme - PLATINUM (all other achievements)
...
const handleAnswerClick = async (answer) => {
  ...
  const exitQuiz = async () => {
    ...
    // Track perfect score streak and count
  ...
  return (
    <div className={`bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg p-8 border border-gray-700 hover:border-amber-500 transition-all ${featured ? 'shadow-2xl' : 'shadow-lg'}`}>}
      ...
      <div className="space-y-4">
        <div>
          <h3 className="ext-gray-400 uppercase text-xs tracking-wider mb-2">Definition</h3>}
          <p className="text-gray-100 text-lg leading-relaxed">{wordData.definition}</p>}
        </div>
        
        <div>
          <h3 className="ext-gray-400 uppercase text-xs tracking-wider mb-2">Category</h3>}
