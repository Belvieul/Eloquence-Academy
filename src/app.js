...
```
   cd Desktop\EloquenceAcademy
```
3. Run this command (this will take 2-3 minutes):
```
   npm install
```
...
```
   npm start
```
2. Your browser should automatically open with your website!
3. Test it out! 🎉
4. When done testing, press `Ctrl + C` in Command Prompt to stop
...
3. Name it: `eloquence-academy`
4. Keep it **Public**
5. **DO NOT** check "Initialize with README"
6. Click **"Create repository"**

7. In Command Prompt (in your project folder), run these commands ONE BY ONE:
```
git init
```
```
...
```
```
git remote add origin https://github.com/YOUR_USERNAME/eloquence-academy.git
```
